// 미할당 Document 편집 placeholder (/write/d/[documentId]).
// 기능 5(Write 뷰: TipTap + AI 수정 제안)에서 본체 구현.
...
export default async function UnassignedDocumentEditPage({
  params,
}: {
  ...
  // 미할당 라우트: asset.projectId가 null이어야 한다.
  if (
    !asset ||
    ...
    <section className="mx-auto flex w-full max-w-[720px] flex-col gap-6 px-6 py-8">
      ...
      <div className="rounded-lg border border-border-subtle bg-bg-secondary p-6">
        ...
        <p className="mt-2 text-caption text-text-secondary">
          현재는 Document의 생성·삭제·재료 연결 플로우만 동작합니다.
        </p>
      </div>
    </section>
  )
